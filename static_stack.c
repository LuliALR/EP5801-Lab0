...
typedef struct STACK {
    ...
    item_struct stack_arr[MAX_STACK_SIZE];
...
int main()
{
    ...
    /*Crear la pila con los items*/
    stack_struct stack = {{item_1, item_2, item_3, item_4, item_5, item_6, item_7}, 7};
...
bool is_full(stack_struct stack)
{
    return stack.item_counter == MAX_STACK_SIZE - 1;
}
